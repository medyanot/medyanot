---
title: Markaların TikTok serüveni, Kadınlar Günü için reklamlar
image: /assets/img/featured/womens-day-mural-feature.jpg
tag:
  - TikTok
  - Kadınlar
description: TikTok, Türkiye'den markaların daha aktif varlık gösterdiği bir
  mecra haline geliyor. Buna rağmen Z kuşağının gizemi devam ediyor.
date: March 6, 2021 12:00 AM
toc: true
---
...
Polonya’daki son 5 yıldaki protesto eylemlerinin fotoğraflarının sergilendiği “The Archive of Public Protests” sitesinin tasarımı ilginizi çekebilir. Özellikle animasyonlu filtreleme sistemi dikkate değer. Sitenin tasarımını dair daha fazla bilgi için [Behance sayfasına](https://www.behance.net/gallery/114328935/The-Archive-of-Public-Protests) bakabilirsiniz. Site içinse:

{% blocklink %}
[Daha Fazla](https://archiwumprotestow.pl/en/home-page/){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

Markaların yeni logo çalışmalarından iki örneği bu hafta sizinle paylaşıyoruz. Fransız otomobil devi Peugeot, uzun zamandır kullandığı logosunu değiştirerek “flat design” mantığına geçmiş. Popüler bir not alma uygulaması olan Trello ise yeni logosunda humanist sans serif font ve gradient kullanıyor.

{% figure caption: "Peugeot'nun eski ve yeni logosu" %}
<div class="ratio-box" style="padding-bottom: 41.5448852%">
<img alt="Peugeot'nun eski ve yeni logosu" class="lazyload" data-src="/assets/img/content/peugeot-newlogo.jpg">
</div>
{% endfigure %}

{% figure caption: "Trello'nun eski ve yeni logosu" %}
<div class="ratio-box" style="padding-bottom: 41.6666667%">
<img alt="Trello'nun eski ve yeni logosu" class="lazyload" data-src="/assets/img/content/trello-newlogo.jpg">
</div>
{% endfigure %}

CSS’te _transition_ özelliğinin interaktif şekilde anlatıldığı kapsamlı bir yazı için: 

{% blocklink %}
[Daha Fazla](https://www.joshwcomeau.com/animation/css-transitions/){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

{% figure caption: "Gözyaşı tabancası" %}
<div class="ratio-box" style="padding-bottom: 100%">
<img alt="Tear gun by Yi Fei Chen" class="lazyload" data-src="/assets/img/content/tear-gun.jpg">
</div>
{% endfigure %}

Gözyaşlarımızı toplayıp ateşleyebileceğimiz tabanca sonunda icat edildi.

{% blocklink %}
[Daha Fazla](https://bigumigu.com/haber/tear-gun-gozyaslarinizi-dondurup-aglatan-kisiye-atesleyebileceginiz-tabanca/){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

## Araştırma

{% figure caption: "İnsani Gelişme Endeksi raporu" %}
<div class="ratio-box" style="padding-bottom: 56.1914672%">
<img alt="rapor sayfası" class="lazyload" data-src="/assets/img/content/ingev-rapor-kent.jpg">
</div>
{% endfigure %}

İnsani Gelişme Vakfı (İNGEV)’in 30 Büyükşehir kapsamında hazırladığı “İnsani Gelişme Endeksi” araştırmasının sonuçları yayınlandı. Sosyal, kültürel ve ekonomik alanlarda şehirlerin kalkınma düzeylerini kıyaslayan araştırmada, İstanbul, Ankara ve İzmir ilk sıralarda yer alırken, Eskişehir, Sakarya ve Konya da yükselen iller arasında konumlandı. Büyükşehirler arasındaki en büyük farkların toplumsal cinsiyet eşitliği ile şeffaflık kategorilerinde açığa çıktığı görülüyor.

{% blocklink %}
[Daha Fazla](https://ingev.org/haberler/ige-buyuksehirler-2020-insani-gelisme-odulleri-24-subatta-sahiplerini-buldu/){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

Socialbakers’tan Singapur hükümetinin ve bakanlıklarının 2020 yılı sosyal medya performansına dair kapsamlı bir rapor.

{% blocklink %}
[Daha Fazla](https://www.socialbakers.com/blog/singapore-government-performance-report){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

## Pazarlama

İçerik stratejisi oluşturma konusunda kapsamlı ve pratik örneklerle dolu bir yazı.

{% blocklink %}
[Daha Fazla](https://medium.com/s/how-to-build-a-brand/lets-talk-about-how-to-create-a-content-strategy-7935de82e89e){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

Müzeler, hediyelik eşya mağazalarında neyi satacaklarına nasıl karar veriyor? Öğrenmek için Vox’a bağlanıyoruz.

{% blocklink %}
[Daha Fazla](https://www.youtube.com/watch?v=yb0nsX2GHQ0){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

{% figure caption: "IKEA söküm kılavuzu" %}
<div class="ratio-box" style="padding-bottom: 100%">
<img alt="IKEA söküm kılavuzu" class="lazyload" data-src="/assets/img/content/ikea-disassembly.jpg">
</div>
{% endfigure %}

Markalar, sürdürülebilirlik, geri dönüşüm ve tutumluluk trendlerine yaratıcı fikirlerle adapte oluyor. IKEA’nın, ürünleri için “söküm kılavuzları” yayınlaması tam da bu trende dokunan başarılı bir hamle. 2021’in ilerleyen aylarında benzer pazarlama stratejilerinin çoğaldığını göreceğiz.

{% blocklink %}
[Daha Fazla](https://mediacat.com/ikeadan-sokum-kilavuzu-hamlesi/){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

"Veri okur-yazarlığının” dijital pazarlamadaki önemi üzerine LinkedIn’de yayınlayan bu yazıyı tavsiye ederiz.

{% blocklink %}
[Daha Fazla](https://business.linkedin.com/marketing-solutions/blog/best-practices--lead-generation/2021/data-literacy--the-fast-track--or-only-track--to-success-with-di){:target="_blank"}{:rel="noopener noreferrer"}
{% endblocklink %}

## Reklam Dünyası

{% figure caption: "SNUG koltuk reklamı" %}
<div class="ratio-box" style="padding-bottom: 56.25%">
<iframe class="lazyload" title="vimeo-player" data-src="https://player.vimeo.com/video/512444401?byline=0&portrait=0" width="640" height="360" frameborder="0" allowfullscreen></iframe>
</div>
{% endfigure %}

Mobilya markası SNUG, yeni koltuk serisi için değişik bir reklam yayınladı. İster komik ister saçma bulunsun, ürüne ilgi uyandırma konusunda başarılı olduğu mutlak.

{% figure caption: "Skoda kapı sensörü reklamı" %}
<div class="ratio-box" style="padding-bottom: 56.25%">
<iframe class="lazyload" width="800" height="450" data-src="https://www.youtube.com/embed/YDI1Pz8BP_w" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
{% endfigure %}

Skoda’nın “hayat kurtaran” kapı sensörü teknolojisi hakkında eğlenceli bir reklam.
...
Netflix’e hayvan gibi zam gelmiş.
...
Twitter iki yeni özelliğini piyasaya sürmeye hazırlanıyor. Yeni “Süper Takip” özelliği sayesinde, kullanıcılar “premium” içeriklerini takipçilerine bir bedel karşılığında sunabilecekler. Ayrıca, Facebook Groups’a benzer şekilde, ortak ilgi alanlarına sahip insanların buluşmasına imkan verecek “Communities” özelliğini de Twitter’ın yakında kullanıma açacağı özelliklerden olacak.
